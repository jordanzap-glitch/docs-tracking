...
// 7. Path to store in DB (relative path for download)
$filePathForDb = '../uploads/' . $storedName;

try {
    // 8. Fetch department_id and usertype_id from tbl_user
    ...
    // 10. Insert into tbl_fileaudittrails with folder_id = 2
    $status = 'Pending';
    $remarks = null;
    $folderId = 2;
    $stmt2 = $conn->prepare("
