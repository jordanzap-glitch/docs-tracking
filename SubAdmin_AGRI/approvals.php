...
// 3. Fetch Pending Files (user_type = 3, folder_id = 1, status = Pending) — removed department filter
$query = "
  SELECT 
    a.id AS audit_id,
    a.file_id,
          ...
          <div class="section-body">
            ...
            <div class="card">
              <div class="card-header">
                <h4><i class="fas fa-clock text-warning"></i> Pending Files (User Type: 3, Folder ID: 1)</h4>
              </div>
              <div class="card-body">
                  ...
                  <table id="auditTable" class="table table-striped table-hover table-bordered w-100">
                    ...
                    <tbody>
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<tr><td colspan='8' class='text-center text-muted'>No pending records found (User Type 3, Folder ID: 1).</td></tr>";
                      }
                      ?>
                    </tbody>
                  </table>
